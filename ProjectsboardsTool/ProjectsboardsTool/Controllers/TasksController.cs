...
namespace ProjectsboardsTool.Controllers
{
    public class TasksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,ZeitAufwand,Bearbeiter")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,ZeitAufwand,Bearbeiter")] Task task)
        {
            if (ModelState.IsValid)
            {
